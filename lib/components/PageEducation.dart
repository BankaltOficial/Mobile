...
class PageEducationScreen extends StatefulWidget {
  ...
  const PageEducationScreen({
    ...
    this.speechRate = 1, // Velocidade da fala (0.0 - 1.0)
    this.pitch = 1.8, // Tom da voz (0.5 - 2.0)
    this.volume = 1, // Volume (0.0 - 1.0)
  }) : super(key: key);
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  // Seção do título com botão de áudio
                  _buildTitleSection(),
        ...
        if (widget.showAudioButton)
          Container(
            decoration: BoxDecoration(
              color: isSpeaking ? Colors.red.withOpacity(0.1) : Colors.grey.withOpacity(0.1),
